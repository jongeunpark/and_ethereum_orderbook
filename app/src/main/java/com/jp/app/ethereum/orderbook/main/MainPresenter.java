package com.jp.app.ethereum.orderbook.main;
...
import com.jp.app.ethereum.orderbook.orderbook.OrderbookFragment;
...
public class MainPresenter implements MainContract.Presenter {
    ...
    private OrderbookFragment mCoinoneFragment, mKorbitFragment, mBithumbFragment, mEtcFragment;
...
//        getInteralKorbitOrderbook(context);
    ...
    public void getPoloniexLastPrice(Context context) {
        ...
        try {
            lastPrice.getListPrice("USDT_ETH", new LastPriceListener() {
                @Override
    ...
    public void getKrakenLastPrice(Context context) {
        ...
        try {
            lastPrice.getListPrice("ETHEUR", new LastPriceListener() {
                @Override
                public void onSuccess(LastPrice lastPrice) {
                    checkPriceDraw(lastPrice);
                }
    ...
    private void checkPriceDraw(LastPrice price){
        if(mPoloAble == false || mKrakenAble == false){
            if(price.getCode() == LastPrice.CODE_POLONIEX){
                mPoloAble = true;
